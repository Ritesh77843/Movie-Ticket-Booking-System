        ...
        <div className="bg-white rounded-[2.5rem] w-full max-w-md p-8 pt-10 shadow-[0_20px_60px_rgba(0,0,0,0.3)] border-[6px] border-amber-50 relative z-10 mx-4">
          ...
          <div className="flex gap-2 mb-6 mt-4 p-1.5 bg-amber-50/50 rounded-2xl justify-center shadow-inner border border-amber-100">
            <button
              ...
              className={`flex-1 py-1.5 rounded-xl font-bold text-sm tracking-wide transition-all ${loginType === "user"
            ...
            <button
              ...
              className={`flex-1 py-1.5 rounded-xl font-bold text-sm tracking-wide transition-all ${loginType === "admin"
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className={`mt-4 font-black text-lg rounded-[1.2rem] py-3.5 transition-all duration-200 text-white shadow-[0_8px_0_#d49900] active:shadow-[0_0px_0_#d49900] active:translate-y-2 border-2 border-[#fff7cc] ${loginType === "admin"
